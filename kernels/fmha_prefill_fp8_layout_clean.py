...
"""FP8 causal FMHA prefill (paged, vec_k_col_v) for gfx942 — CLEAN, READABLE layout-algebra kernel.
...
_alloc = SmemAllocator(None, arch="gfx942", global_sym_name="fmha_prefill_fp8_layout_clean_smem")
